...
kill_command_batch=$(echo "$PID_actress_detail $PID_movie $PID_actress_movie " | xargs -I {} echo "kill -9 {}")
#$PID_index_censored $PID_index_uncensored $PID_actresses_list_censored $PID_actresses_list_uncensored $PID_genre_censored $PID_genre_uncensored
